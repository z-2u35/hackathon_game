...
export default function MirrorHallwayGame({
  onChoice,
}: MirrorHallwayGameProps) {
  ...
  const handleChoice = (choice: GameChoice) => {
    ...
    switch (choice) {
      case 1:
        result = { hp: -10, item: "Glass Shard" };
        break;
      case 2:
        result = { oil: -5 };
        break;
      case 3:
        result = { sanity: -20, code: "4-0-4" };
        break;
    }

    onChoice?.(choice, result); // ✅ choice chắc chắn là number
  };
          ...
          <div className="max-w-2xl w-full mx-4 bg-zinc-900 border-4 border-amber-600 p-6 rounded-lg font-pixel text-white">
            ...
            <div className="space-y-4 text-lg mb-6">
              <p className="text-zinc-200 leading-relaxed">
                Bạn đi giữa hai hàng gương nứt vỡ. Ánh sáng từ đèn lồng của bạn
                phản chiếu trên những mảnh vỡ, tạo ra những bóng đen kỳ lạ...
              </p>

              <p className="text-red-300 font-bold">
                Đột nhiên, hình phản chiếu của bạn trong gương không làm theo
                động tác của bạn. Nó đưa tay ra xin giúp đỡ, mắt nhìn đầy sợ
                hãi...
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span className="block text-sm text-zinc-400 mt-1">
                  Mất 10 HP (Bị kính cứa), Nhận item &quot;Glass Shard&quot; (Vũ
                  khí)
                </span>
              </button>
              ...
              >
                ...
                <span className="block text-sm text-zinc-400 mt-1">
                  Nhìn thấy con quỷ sau tấm gương → Mất 20 Sanity, Nhận Code mở
                  cửa &quot;4-0-4&quot;
                </span>
              </button>
            </div>
          ...
          {playerChoice === 1 && (
            <div className="space-y-2">
              <p className="text-red-400">
                💔 Bạn bị kính cứa khi nắm tay! Mất 10 HP.
              </p>
          ...
          {playerChoice === 3 && (
            <div className="space-y-2">
              <p className="text-purple-400">
                👁️ Bạn nhìn thấy con quỷ đằng sau gương! Mất 20 Sanity.
              </p>
              <p className="text-green-400">
                🔑 Nhận được mã:{" "}
                <span className="text-blue-400 cursor-pointer hover:underline">
